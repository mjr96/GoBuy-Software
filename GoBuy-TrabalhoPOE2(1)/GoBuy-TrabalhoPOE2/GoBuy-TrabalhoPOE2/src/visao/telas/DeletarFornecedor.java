...
public class DeletarFornecedor extends javax.swing.JFrame {
    ...
    public DeletarFornecedor() {
        ...
        if ((listaFornecedores = cFornecedor.visualizarFornecedores()) != null) {
            ...
            for (Fornecedor fornecedor : listaFornecedores) {
                Object[] dados = {fornecedor.getId(),fornecedor.getNomeFornecedor(), fornecedor.getCnpj(),  fornecedor.getTelefone(), fornecedor.getEndereco(), fornecedor.getCidade(), fornecedor.getGrupoComprador()};
                modelo.addRow(dados);
            }
    ...
    private void initComponents() {
        ...
        tabelaDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "NomeFornecedor", "CNPJ", "Telefone", "Endereco", "Cidade", "GrupoComprador"
            }
        ) {
    ...
    private void tabelaDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaDadosMouseClicked
        ...
        if (resposta == 0) {
            ...
            CFornecedor remover = new CFornecedor();
            if (remover.deletarFornecedor(id)) {
