...
public class DeletarFuncionarios extends javax.swing.JFrame {
    ...
    public DeletarFuncionarios() {
        ...
        if ((listaFuncionarios = cFuncionario.visualizarFuncionarios()) != null) {
            ...
            for (Funcionario funcionario : listaFuncionarios) {
                Object[] dados = {funcionario.getId(),funcionario.getNomeFuncionario(), funcionario.getSalarioFuncionario(), funcionario.getCpf(), funcionario.getEndereco(), funcionario.getTelefone()
                , funcionario.getMatricula(), funcionario.getDataAdmicao(), funcionario.getSexo()};
                modelo.addRow(dados);
            }
    ...
    private void initComponents() {
        ...
        tabelaDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "NomeFuncionario", "Salario", "CPF", "Endereco", "Telefone", "Matricula", "Admicao", "Sexo"
            }
        ) {
    ...
    private void tabelaDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaDadosMouseClicked
        ...
        if (resposta == 0) {
            ...
            if (remover.deletarFuncionario(id)) {
