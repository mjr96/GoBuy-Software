...
public class AlterarFornecedor extends javax.swing.JFrame {
    ...
    public AlterarFornecedor() {
        ...
        if ((listaFornecedores = cFornecedor.visualizarFornecedores()) != null) {
            //criando um modelo para a JTable
            DefaultTableModel modelo = (DefaultTableModel) tabelaDados.getModel();
            for (Fornecedor fornecedor : listaFornecedores) {
                Object[] dados = {fornecedor.getId(),fornecedor.getNomeFornecedor(), fornecedor.getCnpj(),  fornecedor.getTelefone(), fornecedor.getCidade(),fornecedor.getEndereco(),
                     fornecedor.getGrupoComprador()};
                modelo.addRow(dados);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        tabelaDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "NomeFornecedor", "CNPJ", "Telefone", "Endereço", "Cidade", "GrupoComprador"
            }
        ) {
    ...
    private void tabelaDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaDadosMouseClicked
        ...
        if (resposta == 0) {
            ...
            fornecedor.setId(Integer.parseInt(tabelaDados.getValueAt(linha, 0).toString()));
            fornecedor.setNomeFornecedor(tabelaDados.getValueAt(linha, 1).toString());
            fornecedor.setCnpj(tabelaDados.getValueAt(linha, 2).toString());
            fornecedor.setTelefone(tabelaDados.getValueAt(linha, 3).toString());
            fornecedor.setEndereco(tabelaDados.getValueAt(linha, 5).toString());
            fornecedor.setCidade(tabelaDados.getValueAt(linha, 4).toString());
            fornecedor.setGrupoComprador(tabelaDados.getValueAt(linha, 6).toString());

            new FormularioAlterarFornecedor(fornecedor).setVisible(true);
            dispose();
        }
