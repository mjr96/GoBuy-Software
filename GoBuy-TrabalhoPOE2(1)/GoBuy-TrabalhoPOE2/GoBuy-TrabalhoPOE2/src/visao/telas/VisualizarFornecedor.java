...
public class VisualizarFornecedor extends javax.swing.JFrame {
    ...
    public VisualizarFornecedor() {
        ...
        if((listaFornecedores = cFornecedor.visualizarFornecedores()) != null)
        {
            ...
            {
                Object[] dados = {fornecedor.getId(),fornecedor.getNomeFornecedor(), fornecedor.getCnpj(),fornecedor.getTelefone(),fornecedor.getEndereco(),
                    fornecedor.getCidade(),fornecedor.getGrupoComprador()};
                modelo.addRow(dados);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Fornecedor cadastrados");
