...
public class AlterarCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelaDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "CPF", "Endereço", "Telefone", "TipoPessoa", "FormaPagamento", "Obesvações"
            }
        ) {
    ...
    private void tabelaDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaDadosMouseClicked
        ...
        if (resposta == 0) {
            ...
            cliente.setId(Integer.parseInt(tabelaDados.getValueAt(linha, 0).toString()));
            cliente.setNomeCliente(tabelaDados.getValueAt(linha, 1).toString());
            cliente.setCpf(tabelaDados.getValueAt(linha, 2).toString());
            cliente.setEndereco(tabelaDados.getValueAt(linha, 3).toString());
            cliente.setTelefone(tabelaDados.getValueAt(linha, 4).toString());
            cliente.setTipoPessoa(tabelaDados.getValueAt(linha, 5).toString());
            cliente.setFormaPagamento(tabelaDados.getValueAt(linha, 6).toString());
            cliente.setObservacao(tabelaDados.getValueAt(linha, 7).toString());

            new FormularioAlterarCliente(cliente).setVisible(true);
            dispose();
        }
