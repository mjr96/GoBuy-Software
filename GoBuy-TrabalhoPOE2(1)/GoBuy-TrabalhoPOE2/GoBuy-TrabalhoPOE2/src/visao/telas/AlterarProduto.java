...
public class AlterarProduto extends javax.swing.JFrame {
    ...
    public AlterarProduto() {
        ...
        if((listaProdutos = cProduto.visualizarProdutos()) != null)
        {
                //criando um modelo para a JTable
            DefaultTableModel modelo = (DefaultTableModel) tabelaDados.getModel();
            for(Produto produto : listaProdutos)
            {
                Object[] dados = {produto.getId(), produto.getDescricao(),produto.getQuantidadeEstoque(),produto.getPrecoCusto(),produto.getPorcentagemLucro(),produto.getPrecoVenda(),produto.getPerecivel()
                    };
                modelo.addRow(dados);
            }
        }
    ...
    private void initComponents() {
        ...
        tabelaDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Descriçao", "Estoque", "PreçoCusto", "Porcentagem", "PreçoVenda", "Perecivel"
            }
        ) {
    ...
    private void tabelaDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaDadosMouseClicked
        ...
        if(resposta == 0)
        {
            ...
            produto.setId(Integer.parseInt(tabelaDados.getValueAt(linha, 0).toString()));
            produto.setDescricao(tabelaDados.getValueAt(linha, 1).toString());
            produto.setQuantidadeEstoque(Integer.parseInt(tabelaDados.getValueAt(linha, 2).toString()));
            produto.setPrecoCusto(Double.parseDouble(tabelaDados.getValueAt(linha, 3).toString()));
            produto.setPorcentagemLucro(Double.parseDouble(tabelaDados.getValueAt(linha, 4).toString()));
            produto.setPrecoVenda(Double.parseDouble(tabelaDados.getValueAt(linha, 5).toString()));
            produto.setPerecivel(tabelaDados.getValueAt(linha, 6).toString());
