...
public class DeletarCliente extends javax.swing.JFrame {
    ...
    public DeletarCliente() {
        ...
        if ((listaClientes = cCliente.visualizarClientes()) != null) {
            ...
            for (Cliente cliente : listaClientes) {
                Object[] dados = {cliente.getId(),cliente.getNomeCliente(), cliente.getCpf(), cliente.getEndereco(), cliente.getTelefone(), cliente.getTipoPessoa(), cliente.getFormaPagamento(), cliente.getObservacao()};
                modelo.addRow(dados);
            }
    ...
    private void initComponents() {
        ...
        tabelaDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "CPF", "Endereço", "Telefone", "TipoPessoa", "FormaPagamento", "Observações"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(botaoFechar, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(357, 357, 357))
        );
