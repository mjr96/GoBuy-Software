...
public class DeletarProduto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelaDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Descrição", "Estoque", "PreçoCusto", "Porcentagem", "PreçoVenda", "Perecivel"
            }
        ) {
    ...
    private void tabelaDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaDadosMouseClicked
        ...
        if (resposta == 0) {
            ...
            Integer id = Integer.parseInt(tabelaDados.getValueAt(linha, 0).toString());
            CProduto remover = new CProduto();
            if (remover.deletarProduto(id)) {
